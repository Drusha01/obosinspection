...
namespace App\Livewire\Admin\Administrator\Request\GeneratePdf;
...
class GeneratePdf extends Component
{
    ...
    {
        return view('livewire.admin.administrator.request.generate-pdf.generate-pdf',[
        ])

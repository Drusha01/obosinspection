...
namespace App\Livewire\Admin\InspectorTeamLeader\Inspections\UpcomingInspections;
...
class UpcomingInspections extends Component
{
  ...
  $this->brgy = DB::table('team_target_barangays as ttb')
    ...
    public function render(Request $request)
    {
        ...
        return view('livewire.admin.inspector-team-leader.inspections.upcoming-inspections.upcoming-inspections',[

...
namespace App\Livewire\Admin\InspectorTeamLeader\Request\AcceptedRequest;
...
class AcceptedRequest extends Component
{
    use WithPagination;
    use WithFileUploads;
    public $title = "Accepted Notifications";
    public $filter = [
    ...
    public function render(Request $request)
    {
        ...
        return view('livewire.admin.inspector-team-leader.request.accepted-request.accepted-request',[

...
namespace App\Livewire\Admin\InspectorTeamLeader\Request\GenerateRequest;
...
class GenerateRequest extends Component
{
    ...
    public function render(Request $request)
    {
        ...
        return view('livewire.admin.inspector-team-leader.request.generate-request.generate-request',[
    ...
    public function generate_request_pdf($modal_id){
        ...
        $this->dispatch('swal:new_page',
            ...
            showConfirmButton 									: 'true',
            timer             									: '1500',
            link              									: ($_SERVER['REMOTE_PORT'] == 80? 'https://': 'http://' ).$_SERVER['SERVER_NAME'].'/inspector-team-leader/request/generate-request-pdf/'.$this->request['business_id'].'/'.$this->request['request_date'].'/'.$this->request['expiration_date'],
        );
        $this->dispatch('openModal',$modal_id);
    }

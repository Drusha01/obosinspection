            ...
            <div class="modal-dialog modal-md modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form wire:submit.prevent="save_add('addModaltoggler')">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="name" class="form-label">Work Role name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" required wire:model="work_role.name" placeholder="Enter work role">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close">Close</button>

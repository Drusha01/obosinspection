                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            @elseif($issue_inspection['step'] == 2)
                                <div wire:key="{{$issue_inspection['step']}}">
                                    <div class="input-group mb-3">
                                        <select class="form-select" id="teamLeaderSelect" disabled wire:model="issue_inspection.item_id">
                                            <option value="">Select Item</option>
                                            @foreach($issue_inspection['items'] as $key =>  $value)
                                                <option selected value="{{$value->id}}">{{$value->name.' ( '.$value->category_name.' )'}}</option>
                                            @endforeach
                                        </select>
                                        <button class="btn btn-primary" type="button" disabled wire:click="update_inspection_items()" ><i class="bi bi-plus"></i></button>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover bg-secondary" style="border-radius: 10px; overflow: hidden;">
                                            <thead class="table-dark" style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
                            ...
                            @elseif($issue_inspection['step'] == 4)
                                <div wire:key="{{$issue_inspection['step']}}">
                                    <div class="input-group mb-3">
                                        <select class="form-select" id="teamLeaderSelect" disabled wire:model="issue_inspection.sanitary_billing_id">
                            ...
                            @elseif($issue_inspection['step'] == 6)
                                <div wire:key="{{$issue_inspection['step']}}">
                                    <div class="input-group mb-3">
                                        ...
                                        <button class="btn btn-primary" type="button" disabled wire:click="update_inspection_team_leader()"><i class="bi bi-plus"></i></button>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover bg-secondary" style="border-radius: 10px; overflow: hidden;">
                                            <thead class="table-dark" style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
                            ...
                            @elseif($issue_inspection['step'] == 7)
                                <div wire:key="{{$issue_inspection['step']}}">
                                    <div class="input-group mb-3">
                                        <select class="form-select" id="teamLeaderSelect" disabled wire:model="issue_inspection.inspector_member_id">
                            ...
                            @elseif($issue_inspection['step'] == 8)
                                <div wire:key="{{$issue_inspection['step']}}">
                                    <div class="input-group mb-3">
                                        <select class="form-select" id="teamLeaderSelect" disabled wire:model="issue_inspection.violation_id">

                    ...
                    <form wire:submit.prevent="save_add('addModaltoggler')">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" required wire:model="business_type.name"  placeholder="Enter description">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close">Close</button>
        ...
        <div wire:ignore.self class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form wire:submit.prevent="save_edit({{$business_type['id']}},'editModaltoggler')">
                            <div class="modal-body">
                            <div class="mb-3">
                                <label for="name" class="form-label">Description <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" required wire:model="business_type.name"  placeholder="Enter description">
        ...
        <div wire:ignore.self class="modal fade" id="deactivateModal" tabindex="-1" aria-labelledby="deactivateModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form wire:submit.prevent="save_deactivate({{$business_type['id']}},'deactivateModaltoggler')">
                        <div class="modal-body">
                            <div>Are you sure you want to deactivate this busitess type?</div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close">Close</button>
        ...
        <div wire:ignore.self class="modal fade" id="activateModal" tabindex="-1" aria-labelledby="activateModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form wire:submit.prevent="save_activate({{$business_type['id']}},'activateModaltoggler')">
                        <div class="modal-body">
                            <div>Are you sure you want to activate this busitess type?</div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close">Close</button>

                        ...
                        <form wire:submit.prevent="save_add('addModaltoggler')">
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" wire:model="person.img_url"accept="image/png, image/jpeg"   placeholder="Image">
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="first_name" class="form-label">First Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" required wire:model="person.first_name" placeholder="Enter first name">
                                    </div>
                                    <div class="mb-3">
                                        <label for="last_name" class="form-label">Last Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" required wire:model="person.last_name" placeholder="Enter last name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="middle_name" class="form-label">Middle Name</label>
                                        <input type="text" class="form-control" wire:model="person.middle_name" placeholder="Enter middle name">
                                    </div>
                                    <div class="mb-3">
                        ...
                        <form wire:submit.prevent="save_edit({{$person['id']}},'editModaltoggler')">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="first_name" class="form-label">First Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" wire:model="person.first_name" required placeholder="Enter first name">
                                    </div>
                                    <div class="mb-3">
                                        <label for="last_name" class="form-label">Last Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" required wire:model="person.last_name" placeholder="Enter last name">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label for="suffix" class="form-label">Suffix</label>
                                        <input type="text" class="form-control" wire:model="person.suffix" placeholder="Enter suffix name">
                                    </div>

        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-between my-3">
                ...
                <div class="col-4 d-flex justify-content-end">
                    <button class="btn btn-primary mx-2" wire:click="request_list_modal('requestCategoryListModaltoggler')">
                        Request Lists
                    </button>
        ...
        <div wire:ignore.self class="modal fade" id="deactivateModal" tabindex="-1" aria-labelledby="deactivateModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form wire:submit.prevent="save_deactivate({{$business_category['id']}},'deactivateModaltoggler')">
                        <div class="modal-body">
        ...
        <div wire:ignore.self class="modal fade" id="activateModal" tabindex="-1" aria-labelledby="activateModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form wire:submit.prevent="save_activate({{$business_category['id']}},'activateModaltoggler')">
                        <div class="modal-body">

                        ...
                        <div class="modal-body">
                            ...
                            @elseif($issue_inspection['step'] == 4)
                                <div wire:key="{{$issue_inspection['step']}}">
                                    ...
                                    @foreach($issue_inspection['inspector_item_category'] as $key =>  $value)
                                        <p>{{$value->name}}</p>
                                    @endforeach
                                    <div class="input-group mb-3">
                            ...
                            @elseif($issue_inspection['step'] == 8)
                                <div wire:key="{{$issue_inspection['step']}}">
                                    ...
                                    @foreach($issue_inspection['inspector_violation_category'] as $key =>  $value)
                                        <p>{{$value->name}}</p>
                                    @endforeach
                ...
                <div class="modal-dialog modal-xl modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            @if(isset($this->issue_inspection['inspection']) && $this->issue_inspection['inspection']->status_id == 2 )

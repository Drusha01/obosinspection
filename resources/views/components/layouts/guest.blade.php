...
<html lang="en">
    <head>
        ...
        <title>{{ config('app.name', 'OBOS') }} - {{ $title ?? '' }}</title>
        <!-- Favicon -->
        ...
        <link href="{{ asset('/sweetalert2-11.10.1') }}/dist/sweetalert2.min.css" rel="stylesheet">
    ...
    <!-- jQuery (ensure jQuery is loaded before using jQuery functions) -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

    <!-- SweetAlert -->
    <script src="{{ asset('/sweetalert2-11.10.1') }}/dist/sweetalert2.all.min.js"></script>
